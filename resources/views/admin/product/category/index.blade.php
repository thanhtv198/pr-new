                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <div id="header" view="header">
                                        <div class="main">
                                            {!! Form::open(['route' => 'search_category', 'method' => 'get', 'class' => 'form-signin']) !!}
                                ...
                                <div class="col-sm-12">
                                    <table id="example2" class="table table-bordered table-hover dataTable" role="grid" aria-describedby="example2_info">
                                        ...
                                        <tr role="row">
                                            ...
                                            <th class="sorting_asc" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-sort="ascending" aria-label="Rendering engine: activate to sort column descending">
                                                {{ trans('common.product.parent_category') }}
                                            </th>
                                        ...
                                        @foreach($categories as $row)
                                            <tr role="row" class="odd">
                                                ...
                                                <td class="textC">
                                                    ...
                                                    <a href="{{ route('category.delete', $row->id) }}" onclick="return confirm({{ trans('common.form.confirm') }})">
